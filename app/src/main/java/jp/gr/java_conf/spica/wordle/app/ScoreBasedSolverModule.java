...
import jp.gr.java_conf.spica.wordle.solver.system.SystemIoEvaluationResultSupplier;

public class ScoreBasedSolverModule extends AbstractModule {

  @Override
  protected void configure() {
    bind(IWordRepository.class).to(WordFileRepository.class);
    bind(IWordleStrategy.class).to(ScoreBasedStrategy.class);
    bind(IEvaluationResultSupplier.class).to(SystemIoEvaluationResultSupplier.class);
  }
}
